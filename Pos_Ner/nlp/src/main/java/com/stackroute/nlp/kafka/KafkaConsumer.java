...
public ConsumerFactory<String, SpellCheckResult> consumerFactory1() {
   return new DefaultKafkaConsumerFactory<String,SpellCheckResult>(consumerconfigs1(),null, new JsonDeserializer<SpellCheckResult>( SpellCheckResult.class));
}
  @Bean
   public ConcurrentKafkaListenerContainerFactory<String, SpellCheckResult>
     kafkaListenerContainerFactory1() {
   
      ConcurrentKafkaListenerContainerFactory<String, SpellCheckResult> factory
         = new ConcurrentKafkaListenerContainerFactory<String, SpellCheckResult>();
